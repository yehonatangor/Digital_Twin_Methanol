#pragma once
// Fixed-bed pressure gradient. Van-Dal & Bouallou (2013) Sec. 2.3.2 states the Ergun equation is used but reports no dP value
// There is no exact gate

#include "transport.hpp"

namespace reactor {

// Lengths m, densities kg/m3 
// particle_density_kg_m3 is the particle density, not the bulk bed density
struct BedGeometry {
...
// W = rho_bulk*A_c*z  =>  dP/dW = (dP/dz)/(rho_bulk*A_c). W and molar flows are per tube 
// multiply by n_tubes at the plant boundary
